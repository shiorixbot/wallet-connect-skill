/**
 * Quote command — fetch a quote from Uniswap Trade API.
 *
 * Usage:
 ...
 * To execute, use: swap --token ETH --out USDC --amount 0.1 --address 0x...
 ...
 * Shared by both `quote` (quote-only) and `swap` (quote + send).
 */
