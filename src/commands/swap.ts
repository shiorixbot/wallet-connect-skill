/**
 * Swap command — fetch a Uniswap quote and send the swap transaction via WalletConnect.
 *
 * Usage:
 *   tsx src/cli.ts swap --token ETH --out USDC --amount 0.1 --address 0x... [--chain eip155:1] [--slippage 0.5] [--deadline 1800]
 *
